...
Haskell also has a String data type. Although Strings are represented by double quotations, they are actually stored as a list of characters. Thus, when specifiying a data type, String is equivalent to [Char]. 

\begin{minted}{haskell}
let str1 = ['H','a','s','k','e','l','l','!']
let str2 = "Haskell!" 	-- a string representation of str1
\end{minted}
...
If the context does not suggest the type, as in the example below, then an exception will result. 
