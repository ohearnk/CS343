...
Haskell also has a String data type. Although Strings are represented by double quotations, they are actually stored as a list of characters. Thus, when specificying a data type, String and [Char] are equivalent. 
